...
\fancyfoot[R]{\scriptsize\color{lightgray} Anci, Elio Valentino } 
\fancyfoot[C]{\thepage}
...
\include{chapters/4_integracion_real/main}

\include{chapters/5_transformada/main}

\include{chapters/0_recordatorios/main}

\include{excercises/recomended}
