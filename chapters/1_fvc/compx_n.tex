...
$$
j = \sqrt{-1} \quad \text{o bien} \quad j^2 = -1
$$
...
\begin{itemize}
  \item Paso 1: Escribir \( z \) en forma polar:
    \begin{gather*}
      \text{Módulo: }r = |8j| = 8 \qquad \text{Argumento: } \theta = \frac{\pi}{2}
    \end{gather*}
  \item Paso 2: Aplicar la fórmula con \( n = 3 \):
    ...
    \end{itemize}
\end{itemize}
Formando un triangulo equilátero en $\mathbb{C}$.
\end{example}
