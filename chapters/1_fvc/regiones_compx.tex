...
En esta sección se considerarán algunas curvas y regiones importantes, así como algunos conceptos relacionados con éstas, que serán usados con frecuencia. 
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{.45\textwidth}
    \centering
    \begin{tikzpicture}
      \draw[->] (-1,0) -- (3,0) node[right] {\scriptsize$\operatorname{Re}(z)$};
      \draw[->] (0,-.3) -- (0,3) node[above] {\scriptsize$\operatorname{Im}(z)$};
      \filldraw[blue] (1.5,1.5) circle (2pt) node[above right] {\scriptsize$a$};
      \draw[red] (1.5,1.5) circle (1);
      \draw[->] (1.5,1.5) -- (.5,1.5) node[midway, above] {\scriptsize$\rho$};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{.45\textwidth}
    ...
    \begin{tikzpicture}[scale=0.7]
      % Ejes
      \draw[->] (-1,0) -- (5,0) node[right] {\scriptsize$\operatorname{Re}(z)$};
      \draw[->] (0,-.3) -- (0,5) node[above] {\scriptsize$\operatorname{Im}(z)$};

      % Centro a
      \filldraw[blue] (2.5,2.5) circle (2pt) node[below] {\scriptsize$a$};
      ...
      % Radio de la menor
      \draw[->] (2.5,2.5) -- ++(60:1.5)
        node[midway, right] {\scriptsize$\rho_1$};
      % Radio de la mayor
      \draw[->] (2.5,2.5) -- ++(120:2.3)
        node[midway, below left] {\scriptsize$\rho_2$};
    \end{tikzpicture}
...
\begin{example}
  ...
  Gráficamente puede verse la región en la figura \ref{fig:ejemplo_de_region}.
  \begin{figure}[ht]
    \centering
    \begin{tikzpicture}[scale=0.8]
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Circunferencia centrada en $(3,-1)$.}
    \label{fig:ejemplo_de_region}
  \end{figure}
\end{example}
