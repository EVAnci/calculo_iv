...
Como bien ya vimos en la sección \ref{sec:singularidad} una singularidad son los puntos de una función donde esta no es diferenciable. La serie de Laurent nos permite conocer y clasificar mejor los distintos tipos de singularidades.
...
\begin{definition}[Esencial]
  Las singularidades esenciales acontecen cuando el número de términos con exponente negativo en el desarrollo en serie de Laurent es infinito. En ese caso $z=z_0$ constituye una \textbf{singularidad esencial}.
\end{definition}
