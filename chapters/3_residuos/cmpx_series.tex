...
\begin{example}(Método de integración)
  ...
  \frac{1}{1+z^2}
  $$
  Si se integra este último resultado, evidentemente se vuelve a obtener $f$, entonces podemos desarrollar la serie de Taylor de este último resultado (aplicaremos el método de sustitución en este caso) y luego integrar término a término. 
  $$
