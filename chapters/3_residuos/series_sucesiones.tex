...
\begin{definition}[Sumas parciales]
  ...
  $$
  Esta última expresión es muy útil, pero no siempre es sencilla de encontrar. La suma $k$-ésima (o $n$-ésima en otras bibliografías) nos permite determinar la convergencia de una serie.
\end{definition}
...
\begin{definition}[Convergencia de la serie]
  ...
  La suma de una serie infinita se define como el límite de sus sumas parciales, si existe:
  $$
  ...
  Si el límite existe y es finito decimos que converge. Si no, la serie diverge. Si una serie converge a un valor $S$, este valor se llama \textbf{suma de la serie}. En general resulta difícil encontrar una expresión del término $k$-ésimo de las sumas parciales, y por ende calcular la suma de una serie resulta complicado.
\end{definition}
...
Los criterios o pruebas de convergencia de una serie son útiles para comprobar la convergencia de una serie. Es decir, nos permiten aplicar un procedimiento para obtener conclusiones rápidamente sobre la convergencia de una serie.
...
$$
y entonces la suma de la serie se puede calcular con la fórmula dada y es el primer término $a=1/2$ y la razón $r=1/2$ y a esto, luego podemos sumarle $5$.

Ahora sí, dejamos de entretenernos con las series geométricas y pasamos al caso más general: las series de potencias. 
...
$$
con lo que la revisión de series queda terminada. A continuación expandiremos este concepto de serie de Taylor para números complejos.
