...
En el plano complejo usual, para evaluar $f(z)$ en $(z\to\infty)$, resulta claro que debemos contar con una curva $\Phi$ infinitamente grande tal que ``encierre'' a la singularidad de la ubicación no finita.

Esto ya plantea una evidente dificultad, dado que la posibilidad de trazar esa curva no existe realmente.
...
$$
\res{t=0}f\left(\frac{1}{t}\right) = \lim_{t\to 1} \left( \frac{1}{j2\pi}\oint_\Gamma f\left(\frac{1}{t} d\frac{1}{t}\right) \right)
$$
