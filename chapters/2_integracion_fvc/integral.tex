...
\begin{example}
  ...
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[very thick,dashed,blue!50!green] (0,0) -- (1.6,1.6) node[left=6pt] {\scriptsize$\Gamma_1$};
      \draw[very thick,dashed,red] (0,0) -- (1.6,0) -- (1.6,1.6) node[below right] {\scriptsize$\Gamma_2$};
      \node[below,red] at (.8,0) {\scriptsize$\Gamma_{2a}$};
      \node[left,red] at (1.6,.8) {\scriptsize$\Gamma_{2b}$};
    \end{tikzpicture}
  \end{figure}
