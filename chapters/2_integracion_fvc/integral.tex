...
$$
de modo que $\Phi$ empieza donde termina $\Gamma$ ($\varPhi(a)=\Gamma(b)$) y termina donde $\Gamma$ empieza ($\varPhi(b)=\Gamma(a)$), es la curva $\Gamma$ recorrida en sentido inverso. Invertir la orientación cambia el signo de la integral
$$
