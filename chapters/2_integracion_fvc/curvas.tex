...
\begin{example}
  ...
  \input{chapters/2_integracion_fvc/media/parabola.tex}
...
\begin{example}
  ...
  \input{chapters/2_integracion_fvc/media/circunferencia_abierta.tex}
